...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _itemprop = __webpack_require__(9);
	
	var _itemprop2 = _interopRequireDefault(_itemprop);
	
	var _reactUiComponents = __webpack_require__(10);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var IconButtonComponent = function IconButtonComponent(props) {
	    var finalProps = (0, _lodash2.default)(props, ['formattingRule']);
	    return _react2.default.createElement(_reactUiComponents.IconButton, finalProps);
	};
	
	(0, _neosUiExtensibility2.default)('Sfi.Site:Itemprop', {}, function (globalRegistry) {
	    var plugins = globalRegistry.get('ckEditor').get('plugins');
	...
	exports.default = function (CKEDITOR) {
	    CKEDITOR.plugins.add('itemprop', {
	        init: function init(editor) {
	            ...
	            CKEDITOR.dialog.add('itempropDialog', function (editor) {
	                return {
	                    title: 'Itemprop',
	                    contents: [{
	                        id: 'tab-main',
	                    ...
	                    onShow: function onShow() {
	                        ...
	                        var tdElement = element.getAscendant('td', true);
